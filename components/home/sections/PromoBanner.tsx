...
export function PromoBanner() {
  return (
    <div className="bg-[#8B3A3A] py-3 mb-8 md:mb-10 flex items-center justify-center overflow-x-auto scrollbar-hide">
      <p className="flex items-center gap-1.5 sm:gap-2.5 font-body text-[0.6rem] sm:text-[0.72rem] tracking-[0.08em] sm:tracking-[0.1em] uppercase text-lp-porcelain whitespace-nowrap px-2">
