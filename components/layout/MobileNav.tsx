          ...
          return (
            ...
            >
              <div className="relative">
                ...
                {isCart && cartCount > 0 && (
                  <span className="absolute -top-1.5 -right-1.5 w-[16px] h-[16px] rounded-full bg-[#332619] text-lp-porcelain text-[8px] font-semibold flex items-center justify-center tabular-nums">
